...
go build -ldflags "${VERSION_INFO}" -tags 'logicrichos securerichos' -o dist/india/india forgerock.org/cmd/india
go build -ldflags "${VERSION_INFO}" -tags 'logicrichos securerichos' -o dist/echo/echo forgerock.org/cmd/echo
